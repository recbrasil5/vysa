(function () {
    ...
    angular.module("vysaApp").controller('AdminPlayersController',
        function ($scope, $location, metaDataService, notifierService, AdminPlayerRepository, adPlayersDataDeliveryService) {
            ...
            function getGridData(pageNo) {
                ...
                // loadAll
                handleDataCallback(adPlayersDataDeliveryService.getPlayersGridView(pageNo, $scope.recordsPerPage, $scope.sort));
            }

            function handleDataCallback(promise) {
                promise.then(function (data) {
                    if (data.count > 0) {
                        $scope.gridData = data.players;
            ...
            function setupScopeVars() {
                ...
                $scope.gridHeaderItems = metaDataService.getPlayersGridHeaders;
            }
