...
namespace VYSA.WebApi.Controllers
{
    ...
    public class MailingListMemberController : BaseController
    {
        ...
        [HttpPost]
        [Route("")]
        [ResponseType(typeof(MailingListMemberResourceModel))]
        public IHttpActionResult CreateMailingListMember(MailingListMemberResourceModel mailingListMemberDto)
        {
