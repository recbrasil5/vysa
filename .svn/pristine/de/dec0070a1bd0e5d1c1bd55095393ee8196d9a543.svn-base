...
namespace VYSA.WebApi.Services
{
    public class MailingListMemberService : BaseService
    {
        ...
        public IEnumerable<MailingListResourceModel> GetMailingList(FilterBindingModel bm)
        {
            ...
            //TODO: Add ParentReps if you ever go back to using this code
        ...
        public MailingListMemberResourceModel AddMailingListMember(MailingListMemberResourceModel newMailingListMemberDto, string lastUpdateBy)
        {
            ...
            EmailProvider.SendMailingListMemberVerificationEmail(newMailingListMemberDto);
        ...
        public ICollection<MailingListMemberResourceModel> GetMailingListFilter(MailingListMemberFilterBindingModel bm, Enums.FilterReturnType filterAction)
        {
            QueryObject queryObject = BuildFilterQuery(bm, filterAction);
            return _unitOfWork.Context.Database.SqlQuery<MailingListMemberResourceModel>(queryObject.Query, queryObject.FilterParameters.ToArray()).ToList();
        }
